      ...
      <section className="bg-white pt-16">
        <div className="max-w-7xl mx-auto px-7 grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className=" col-span-2 ">
            ...
            <p className="text-sm text-[#119d3e] font-semibold">ADDRESS: <span className='text-gray-600'>Roda WQ 966 Munich Express,<br /> 70Germany, Park Lan, TX 7859</span></p>
            ...
            <div >
              <div className='flex justify-start items-center gap-4 mt-9'>
                ...
                <div>
                  <p className="text-sm text-gray-700 font-semibold">CUSTOMER SERVICE:</p>
                  <p className="text-gray-600 text-sm">
                    <span className="text-gray-500 font-medium">+9-555-888-679</span>, <span className="text-gray-500 font-medium">+9-666-888-679</span>
                  </p>
                </div>
              </div>
              ...
              <div className='flex justify-start items-center gap-4 mt-3'>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 font-semibold">CAREERS:</p>
                  <p className="text-gray-500 font-medium">exemple@info.com</p>
                </div>
              </div>
            </div>
            <div className='border-b-2 border-dashed border-gray-300 mt-3'>
            ...
            <div className='flex justify-start items-center gap-2'>
              ...
              <div className="flex items-center justify-center p-3 space-x-3 ">
                <a rel="noopener noreferrer" href='' title="Email" className="dark:text-gray-600 hover:text-[#119d3e]">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                  </svg>
                </a>
                <a rel="noopener noreferrer" href='' title="Twitter" className="dark:text-gray-600 hover:text-[#119d3e]">
                ...
                <a rel="noopener noreferrer" href='' title="LinkedIn" className="dark:text-gray-600 hover:text-[#119d3e]">
                ...
                <a rel="noopener noreferrer" href="#" title="GitHub" className="dark:text-gray-600 hover:text-[#119d3e]">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
