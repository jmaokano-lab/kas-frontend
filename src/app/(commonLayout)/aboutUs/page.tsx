...
import { Fish, Waves, Heart, Shield, Truck, Award, Users, Leaf } from 'lucide-react';
...
const Stat: React.FC<StatProps> = ({ number, label, icon }) => (
  <div className="group relative">
    ...
    <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="text-4xl font-bold bg-gradient-to-r from-[#119d3e] to-[#0d7a30] bg-clip-text text-transparent mb-2">{number}</div>
  ...
  const values: ValueProps[] = [
    {
      ...
      description: 'We source only the freshest, highest-quality fish directly from trusted fishermen and sustainable farms.'
    },
    {
      icon: <Leaf className="w-8 h-8 text-white" />,
      title: 'Sustainable Fishing',
      description: 'Committed to eco-friendly practices that protect our oceans and ensure fish populations for future generations.'
    },
    {
      icon: <Shield className="w-8 h-8 text-white" />,
      title: 'Freshness Guaranteed',
      description: 'Every fish is carefully inspected and delivered fresh to your door with our 100% freshness guarantee.'
    },
    {
      icon: <Truck className="w-8 h-8 text-white" />,
      title: 'Fast Delivery',
      description: 'Temperature-controlled delivery ensures your seafood arrives in perfect condition, fresh as the ocean.'
    }
  ];
  return (
      ...
      <section className="relative py-20 px-7 max-w-7xl mx-auto overflow-hidden " >
        ...
        <div className="absolute top-0 left-0 w-full opacity-5">
          <svg viewBox="0 0 1200 120" className="w-full h-32">
            <path d="M0,60 Q300,20 600,60 T1200,60 L1200,0 L0,0 Z" fill="#119d3e" />
          </svg>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We're passionate about bringing the freshest seafood from the ocean to your table.
              With a commitment to quality, sustainability, and customer satisfaction, we've become
              the trusted choice for seafood lovers everywhere.
            </p>
          </div>
          ...
          <div className="relative mb-20 h-full bg-cover bg-center bg-no-repeat"
            style={{
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Born from a love of the sea and fresh seafood, we started our journey as a small
                    family business at the local harbor. What began with a simple boat and a passion
                    for quality fish has grown into a thriving e-commerce platform serving thousands
                    of happy customers.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Every morning, we work directly with local fishermen and sustainable farms to
                    handpick the finest catch. Our commitment to freshness means your fish goes from
                    ocean to table in record time.
                  </p>
                </div>
                <div>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    We believe everyone deserves access to premium, fresh seafood without the hassle
                    of visiting the fish market. That's why we've invested in state-of-the-art
                    cold-chain logistics and quality control to ensure every order arrives perfect.
                  </p>
                  <div className="flex items-center gap-4 mt-6">
                    <div className="flex items-center gap-2">
                      <Award className="w-5 h-5 text-[#119d3e]" />
                      <span className="text-sm text-gray-700 font-medium">Certified Fresh</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Leaf className="w-5 h-5 text-[#119d3e]" />
                      <span className="text-sm text-gray-700 font-medium">Eco-Friendly</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                We're more than just a fish store. We're your partners in bringing the best of the ocean
                to your kitchen with care, quality, and sustainability.
              </p>
            </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-4 bg-gradient-to-r from-[#119d3e] to-[#0d7a30] text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                Shop Fresh Fish Now
              </button>
              <button className="px-8 py-4 bg-white text-[#119d3e] font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-[#119d3e]">
                Contact Us
              </button>
            </div>
          </div>
