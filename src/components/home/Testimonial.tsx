...
export default function Testimonial() {
    ...
    return (
        <section className="py-16 px-6 bg-[#052F35] text-white bg-cover bg-center"
        ...
        >
            ...
            <Marquee gradient={false} speed={30} direction="left">
                ...
                {testimonials.map((testimonial, index) => (
                    <div key={index} className="bg-[#083a3f] p-6 rounded-lg shadow-xl mx-6 max-w-80 h-[400px]"
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-lg text-center italic">
                                "{testimonial.quote.slice(0, 150)}{testimonial.quote.length > 150 ? '...' : ''}"
                            </p>
