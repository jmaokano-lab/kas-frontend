          ...
          <div className="relative w-full border-l-8 border-[#119d3e] lg:w-1/2 space-y-6 ">
            ...
            <div className="space-y-6 ml-8 py-12">
              <div className="inline-flex items-center gap-3 pl-4 py-2 pr-2 rounded-full bg-[#03363f] border border-[#17c964]">
                <span className="text-[#119d3e] text-lg">
              ...
              <p className="max-w-md text-sm sm:text-base text-white/70">
                Hygienic handling, expert preparation, and reliable home
                delivery service. Eco-friendly packaging, trained processing
                staff, and fast delivery to your doorstep.
              </p>

              <Link
                href={"/products"}
                className="inline-flex items-center ease-in-out duration-300 gap-6 px-2 py-2 rounded-full bg-gradient-to-r from-[#1EA9B6] to-[#65B748] text-sm sm:text-base font-semibold shadow-lg shadow-black/40 hover:scale-105 transition-transform"
              >
                GET PRICING
