        ...
        <div className="flex items-center gap-3 md:gap-5  px-3 py-2 md:px-6 absolute ml-3 ">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="font-semibold hover:text-[#27c36e]"
            >
              kasnyusa@gmail.com
            </a>
          </div>
